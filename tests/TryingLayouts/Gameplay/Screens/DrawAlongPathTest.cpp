...
class TryingLayouts_Gameplay_Screens_DrawAlongPathTest : public ::testing::Test {};
class TryingLayouts_Gameplay_Screens_DrawAlongPathTestWithAllegroRenderingFixture
   : public AllegroFlare::Testing::WithAllegroRenderingFixture
{};
class TryingLayouts_Gameplay_Screens_DrawAlongPathTestWithAllegroFrameworksFullFixture
...
TEST_F(TryingLayouts_Gameplay_Screens_DrawAlongPathTest, can_be_created_without_blowing_up)
{
   TryingLayouts::Gameplay::Screens::DrawAlongPath screen;
}


TEST_F(TryingLayouts_Gameplay_Screens_DrawAlongPathTest, TYPE__has_the_expected_value)
{
   TryingLayouts::Gameplay::Screens::DrawAlongPath screen;
...
TEST_F(TryingLayouts_Gameplay_Screens_DrawAlongPathTest, type__has_the_expected_value_matching_TYPE)
{
   TryingLayouts::Gameplay::Screens::DrawAlongPath screen;
   EXPECT_EQ(TryingLayouts::Gameplay::Screens::DrawAlongPath::TYPE, screen.get_type());
}


*/

TEST_F(TryingLayouts_Gameplay_Screens_DrawAlongPathTestWithAllegroFrameworksFullFixture,
